...
由于我们正在处理编程接口，因此我们需要尽可能地避免猜测发送给我们的内容的含义。鉴于集成对于开发人员来说通常是一次性的任务，
并且我们提供了良好的文档，所以我们必须严格使用接收到的数据。必须权衡 [Postel 定律](https://en.wikipedia.org/wiki/Robustness_principle)与许可分析的许多危险。
