...
参考翻译：[https://blog.csdn.net/ratsniper/article/details/78954852](https://blog.csdn.net/ratsniper/article/details/78954852)
...
- 始终使用 def 表达式，而不是通过赋值语句将lambda表达式绑定到一个变量上。
